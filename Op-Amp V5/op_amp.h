...
public:
    ...
    float* get_resistors(bool feedback, bool resistor_1); //returns a pointer the first value in an array of all four resistor values. This can then be used to return the values of the subsequent resistors.

    //simulation functions
    float* sim(int start, int end, float amplitude, float frequency, float phase, float DC_offset) const; //simulates the Op-Amp output i.e., outputs based on the transfer function.
