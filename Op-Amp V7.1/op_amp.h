...
public:
    ...
    vector<float> get_resistors(bool feedback, bool resistor_1); //returns a pointer the first value in an array of all four resistor values. This can then be used to return the values of the subsequent resistors.
