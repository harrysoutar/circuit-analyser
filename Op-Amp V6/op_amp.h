...
public:
    ...
    vector<float> sim(int start, float amplitude, float frequency, float phase, float DC_offset) const; //simulates the Op-Amp output i.e., outputs based on the transfer function.
